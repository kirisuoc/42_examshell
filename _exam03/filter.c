...
DESCRIPCIÓN:
Leer de stdin y escribir a stdout, pero reeplazando todas las ocurrencias
 ...
 *
 * 2. MANEJO DE ERRORES:
 *    - Usar perror() para errores del sistema
 *    - Retornar códigos de error apropiados
 *    - Validar argumentos antes de usarlos
 *
 * 3. LECTURA DINÁMICA
 *    - El buffer puede llenarse con cuaquier cantidad de datos
